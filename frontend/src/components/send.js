  ...
  render() {
    return (
      <Container>
        <br />
        <h3><b>SudoCoin</b></h3>
        <h4><b style={{ color: '#007bff' }}>Send unlimited dummy file to anyone.</b> </h4>
        <Form onSubmit={this.handleSubmit}>
          ...
          <Form.Group as={Row}>
            ...
            <Col sm="2">
              <Form.Control type="file" label={this.state.file.name} onChange={this.handleFile} placeholder="File" value={this.state.file} />
            </Col>
            <Col sm="0.5"><b> Sudo </b></Col>
          </Form.Group>
          <Form.Group as={Row}>
